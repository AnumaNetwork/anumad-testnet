/*
Package txscript implements the anuma transaction script language.

This package provides data structures and functions to parse and execute
anuma transaction scripts.

# Script Overview

Anuma transaction scripts are written in a stack-base, FORTH-like language.

The anuma script language consists of a number of opcodes which fall into
...
Typical anuma scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend anuma.
